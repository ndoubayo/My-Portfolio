...
var allColorToDark = [listContactsColor];
...
var listTolightBackground = [greetingsBg, ctnrModeBg, contactZonebg];
function backgroundToLight() {
  var _iterator4 = _createForOfIteratorHelper(listTolightBackground),
    _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      var background1 = _step4.value;
...
var nbSlide = projects.length;
var next = document.querySelector('.right-icon');
var prev = document.querySelector('.left-icon');
var count = 0;
