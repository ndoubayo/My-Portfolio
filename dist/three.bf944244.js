...
require("./style.css");
var _bgBaner = _interopRequireDefault(require("../assets/images/bg-baner.jpg"));
...
var material = new THREE.MeshBasicMaterial({
  // color: 0xff0000,
  map: loader.load(_bgBaner.default)
});
